            ...
            <div class="detail-header">
                ...
                <div class="detail-info">
                    ...
                    <div class="action-buttons">
                        <button class="btn btn-sm ${this.isInFavorites(artist.id, 'artist') ? 'btn-outline' : ''}" id="add-favorite-artist" data-id="${artist.id}" data-type="artist">
                            <i class="${this.isInFavorites(artist.id, 'artist') ? 'fas' : 'far'} fa-heart"></i> 
        ...
        try {
            ...
            <div class="detail-header">
                ...
                `<a href="artist.html?id=${artist.id}">${artist.name}</a>`
                    ...
                    <div class="action-buttons">
                        <button class="btn btn-sm ${this.isInFavorites(album.id, 'album') ? 'btn-outline' : ''}" id="add-favorite-album" data-id="${album.id}" data-type="album">
                            <i class="${this.isInFavorites(album.id, 'album') ? 'fas' : 'far'} fa-heart"></i> 
        ...
        favButtons.forEach(button => {
            ...
            newButton.addEventListener('click', (e) => {
                ...
                if (isFavorite) {
                    ...
                    // Si es el botón grande en la página de detalles
                    if (e.currentTarget.id === 'add-favorite-artist' || e.currentTarget.id === 'add-favorite-album') {
